 ...
 * 3. Initializes any new storage variables (e.g., maxRewardsBps)
 *
...
contract UpgradeStakedUSDat is Script {
    ...
    // New storage variable default
    uint256 constant DEFAULT_MAX_REWARDS_BPS = 250; // 2.5%
    ...
    function run() external {
        ...
        // Step 3: Initialize new storage variable
        proxy.setMaxRewardsBps(DEFAULT_MAX_REWARDS_BPS);
        console.log("3. maxRewardsBps set to:", DEFAULT_MAX_REWARDS_BPS);
        ...
        console.log("maxRewardsBps:", proxy.maxRewardsBps());
    }
}
